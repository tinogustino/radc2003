...
tc = `MAAF KA NOMER KAMU BLOM TERDAFTAR DI DATABASE SILAHKAN KETIK !verify UNTUK MENDAFTAR DI ★ Father-Bot WhatsappZ`
ind = {
...
*[ • D O N Z • B O T • ]*`
	    ...
	    reply(`*Terimakasih Telah Terdaftar Di [ • D O N Z • B O T • ]*`)
	}, 2000)
	}
if (budy.toLowerCase() === `5679`){
	if (isRegistered) return reply('Akun kamu sudah terverfikasi')
...
*D O N Z B O T*`
        ...
        // console.log(e)
            setTimeout( () => {
	    ikyy.updatePresence(from, Presence.composing)
	    reply(`*Terimakasih Telah Terdaftar Di DONZBOT*`)
	}, 2000)
	}
///// Auto Read
...
console.log(color('[ Linux Oax1Ys ]'), color(time, 'yellow'), color(`${command} [${args.length}]`), 'from', color(pushname))
if (isCmd && isGroup)
atm.addKoinUser(sender, randomNomor(20), _uang)
console.log(color('[ Linux Oax1Ys ]'), color(time, 'yellow'), color(`${command} [${args.length}]`), 'from', color(pushname), 'in', color(groupName))
//////// < lanjut mas > ////////////
...
╭─❒ 「 ⚠️ *𝚄𝚜𝚎𝚛 𝙸𝚗𝚏𝚘𝚛𝚖𝚊𝚝𝚒𝚘𝚗* 」 ❒
│ ♨️ *𝚄𝚜𝚎𝚛𝚗𝚊𝚖𝚎* : ${pushname}
│ ♨️ *𝙱𝚒𝚘 𝙸𝚗𝚏𝚘* : ${thu.status}
│ ♨️ *𝙿𝚛𝚎𝚖𝚒𝚞𝚖* : ${isPremium ? 'ʏᴀ' : 'ɴᴏ'}
│ ♨️ *𝙰𝚍𝚖𝚒𝚗* : ${isGroupAdmins ? 'ʏᴀ' : 'ɴᴏ'}
│ ♨️ *𝙻𝚎𝚟𝚎𝚕*: ${Levelnye}
│ ♨️ *𝙴𝚡𝚙*: ${Xpluu} / ${requiredXplu}
└─❏
╭─❒ 「 ⚠️ *𝙱𝚘𝚝 𝙸𝚗𝚏𝚘* 」 ❒
│♨️ *𝚂𝚙𝚎𝚎𝚍* : *${latensie.toFixed(4)} _Second_*
│♨️ *𝙰𝚌𝚝𝚒𝚟𝚎* : *${runtime(process.uptime())}*
│♨️ *𝙿𝚕𝚊𝚝𝚏𝚘𝚛𝚖* : *Linux*
└─❏
...
`
    ...
    ikyy.sendMessage(from, { contentText: `${menu}`, footerText: 'ミ★ Father-Bot Whatsapp ★彡', buttons: [{ buttonId: `!command`, buttonText: { displayText: '💢 𝙻𝚒𝚜𝚝 𝙼𝚎𝚗𝚞    ' }, type: 1 },{ buttonId: `!sewabot`, buttonText: { displayText: '💢 𝚂𝚎𝚠𝚊 𝙱𝚘𝚝    ' }, type: 1 },{ buttonId: `!owner`, buttonText: { displayText: '💢 ᴏᴡɴᴇʀ ɴᴜᴍʙᴇʀ' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: ikyads, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
case 'f':
case 'lock':
 ikymekyy = {
...
┗━▹ `
sendButMessage(from, wibu, `created ★ Father-Bot Whatsappz`, [
          {
            buttonId: `!menu`,
            buttonText: {
...
┃▹ ᴄᴀʀᴠᴇᴅᴡᴏᴏᴅ ᴛᴇxᴛ
┃▹ ᴛɪᴋᴛᴏᴋ ᴛᴇxᴛ1 ᴛᴇxᴛ2
┃▹ ᴀʀᴄᴀᴅᴇ8ʙɪᴛ ᴛᴇxᴛ1 ᴛᴇxᴛ2
┃▹ ʙᴀᴛᴛʟᴇꜰɪᴇʟᴅ4 ᴛᴇxᴛ1 ᴛᴇxᴛ2
┃▹ ᴘᴜʙɢ ᴛᴇxᴛ1 ᴛᴇxᴛ2
┗━▹
*ɢᴜɴᴀᴋᴀɴ ᴘʀᴇꜰɪx* *[ ${prefix} ]* *ꜱᴇʙᴇʟᴜᴍ ᴄᴏᴍᴀɴᴅ*
`
   sendButMessage(from, wibu, `created ★ Father-Bot Whatsappz`, [
          {
            buttonId: `!menu`,
        ...
        case 'simi':
				...
				buttons = [{buttonId: `!darkjoke`,buttonText:{displayText: ` ➡️NEXT`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'ミ★ Father-Bot Whatsapp ★彡', imageMessage: imageMsg,
              contentText:`Nih, klik lanjut untuk gambar selanjutnya`,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
break
        case 'ephoto':
...
`
   sendButMessage(from, wibu, `created ★ Father-Bot Whatsappz`, [
        ...
        case 'wasted':
		      ...
		      buttons = [{buttonId: `!infoig`,buttonText:{displayText: ` Follow @bnyk_pnderr`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'ミ★ Father-Bot Whatsapp ★彡', imageMessage: imageMsg,
              contentText:`Follow @bnyk_pnderr`,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
break
				case 'quotesmaker':
      ...
      case 'broadcast2':
             ...
             for (let _ of anu) {
             ikyy.sendMessage(_.jid, bc, image, {quoted:freply,caption: `*「 BROADCAST [ • ★ Father-Bot Whatsapp • ] 」*\n\n${body.slice(4)}`})
}
             reply('Suksess broadcast')
             } else {
             for (let _ of anu) {
ikyy.sendMessage(_.jid, 
	    {"contentText": `*「 BROADCAST [ • ★ Father-Bot Whatsapp • ] 」*\n\n${body.slice(4)}`,
	    "footerText": '©Created by dony',
	    "buttons": [
	    {"buttonId": `!owner`,
...
case 'bc3':
             ...
             if (isMedia && !kyy.message.videoMessage || isQuotedImage) {
             const encmedia = isQuotedImage ? JSON.parse(JSON.stringify(kyy).replace('quotedM','m')).message.extendedTextMessage.contextInfo : kyy
             bc2 = await ikyy.downloadMediaMessage(encmedia)
             for (let _ of anu) {
             ikyy.sendMessage(_.jid, { contentText: `*🌹 SIARAN DONZBOT 🌹*\n\n${body.slice(4)}`, footerText: '©Created by Dony', buttons: [{ buttonId: `${prefix}command`, buttonText: { displayText: 'MENU' }, type: 1 }, { buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER' }, type: 1 }], headerType: 6, locationMessage: { degreesLatitude: 0, degreesLongitude: 0, jpegThumbnail: bc2 }}, 'buttonsMessage')
}
             reply('Suksess broadcast')
}
             break
...
reply (mess.wait)
  ...
  buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=PunyaIkyAds&text=${ini_txt}`)
          buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'ミ★ Father-Bot Whatsapp ★彡', imageMessage: imageMsg,
              contentText:`[ꜱᴜᴄᴄᴇꜱ]`,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
...
buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy2/${command}?apikey=PunyaIkyAds&text1=${txt1}&text2=${txt2}`)
          buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'ミ★ Father-Bot Whatsapp ★彡', imageMessage: imageMsg,
              contentText:`[Succes]`,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
...
`
 ...
 ♥️ ★ Father-Bot Whatsappz`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
...
𝔍𝔞𝔫𝔤𝔞𝔫 𝔭𝔢𝔯𝔫𝔞𝔥 𝔪𝔢𝔫𝔠𝔦𝔫𝔱𝔞𝔦 𝔰𝔢𝔰𝔢𝔬𝔯𝔞𝔫𝔤 
 𝔶𝔞𝔫𝔤 𝔪𝔞𝔰𝔦𝔥 𝔪𝔢𝔫𝔠𝔦𝔫𝔱𝔞𝔦 𝔪𝔞𝔰𝔞??𝔞𝔩𝔲𝔫𝔶𝔞
`
...
┗⬡ `
 ...
 𝔍𝔞𝔫𝔤𝔞𝔫 𝔭𝔢𝔯𝔫𝔞𝔥 𝔪𝔢𝔫𝔠𝔦𝔫𝔱𝔞𝔦 𝔰𝔢𝔰??𝔬𝔯𝔞𝔫𝔤 
  𝔶𝔞𝔫𝔤 𝔪𝔞𝔰𝔦𝔥 𝔪𝔢𝔫𝔠𝔦𝔫𝔱𝔞𝔦 𝔪𝔞𝔰𝔞𝔩𝔞𝔩𝔲𝔫𝔶𝔞
...
🏷 𝐆𝐫𝐨𝐮𝐩 𝐂𝐡𝐚𝐭𝐬 : *${groups.length}*
🏷 𝐏𝐫??𝐯𝐚𝐭𝐞 𝐂𝐡𝐚𝐭𝐬 : *${privat.length}*
🏷 𝐓𝐨𝐭𝐚𝐥 ??𝐡𝐚𝐭𝐬 : *${totalChat.length}*
🏷 𝐒𝐩𝐞𝐞𝐝 : *${latensie.toFixed(4)} _Second_*
🏷 𝐀𝐜𝐭𝐢𝐯𝐞 : *${runtime(process.uptime())}*
🏷 𝐏𝐥𝐚𝐭𝐟𝐨𝐫𝐦 : *${os.platform()}*
...
`
 ...
 ♥️ ★ Father-Bot Whatsappz`, imageMessage: imageMsg,
   ...
   case 'command':
               list = []
               listmenu = [`groupmenu`,`photoxy`,`ephoto`,`randomimage`,`wibu2`,`storymenu`,`porno`,`randomtext`,`islammenu`,`wibumenu`,`stickermenu`,`ownermenu`,`gamemenu`,`funmenu`,`downloadmenu`,`infomenu`,`othermenu`,`owner`,`imagemani`,`ikyygroup`,`sewabot`]
               listmenuu = [`Menu Group`,`Photo Oky`,`Ephoto Menu`,`Random Image`,`Nsfw Anime`,`Movie&Story`,`18+ Menu`,`RandomText`,`Islam Menu`,`Wibu Menu`,`Sticker Menu`,`Owner Command`,`Game Menu`,`For Fun Menu`,`Downloader`,`Info Menu`,`Menu Lainnya`,`OwnerBot`,`imageeffek`,`Official Group`,`Rent this Bot`]
               nombor = 1
               startnum = 0
...
ikyy.sendMessage(sender, "Kode Verify : 5679 \n  \nAnda juga dapat mengetuk tautan ini untuk verifikasi: https://wa.me/6285745716488?text=5679 \n  \nKode ini bersifat sementara dan bisa jadi sama dengan orang lain.", text, {quoted: freply})
break
case 'sfire':
{
...
`
  buttons = [{buttonId: `${prefix}bukti`,buttonText:{displayText: `KIRIM BUKTI TF`},type:1},{buttonId: `${prefix}payment`,buttonText:{displayText: `PAYMENT LAIN`},type:1}]
      ...
      break
         case 'dana':
              gopeynya = `https://l.top4top.io/p_208874oza0.jpg`
            buff = await getBuffer(gopeynya)
            teksnya = `
Hai kak ${pushname}
...
`
    ...
    ikyy.sendMessage(from, { contentText: `${menu}`, footerText: 'Dony', buttons: [{ buttonId: `!bukti`, buttonText: { displayText: 'KIRIM BUKTI TF' }, type: 1 },{ buttonId: `!payment`, buttonText: { displayText: 'GANTI PAYMENT' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: ikyads, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
              case 'bukti':
    titid = `
hai kak ${pushname}
    ...
    break
      ...
      case 'tiktokaudio':
             ...
             ini_link = args[0]
              ...
              ikymekyy = anu.result.audio

             ikyy.sendMessage(from, ikymekyy, audio, { mimetype: Mimetype.mp4Audio, quoted: freply })()
             break
      case 'fbdl':
      case 'fb':
      case 'facebok':
...
reply('Loading.... ')
				play = args.join(" ")
				anu = await fetchJson(`https://api.zeks.xyz/api/ytplaymp4?q=${play}&apikey=ApidashhBot`)
...
buttonsMessage = {contentText: thumbInfo,footerText:'ミ★ Father-Bot Whatsapp ★彡',imageMessage,buttons,headerType:4}
       ...
       case 'hacked':
              ...
              reply('Otw Hack')
                tessgc = await getBuffer(`https://i.ibb.co/m4Qx3JG/20210319-204838.jpg`)
                   ikyy.updateProfilePicture (from, tessgc)
                   await sleep(1000)
                ikyy.groupUpdateSubject(from, `HIJACKED BY ${body.slice(8)}`)
                await sleep(1000)
                ikyy.groupUpdateDescription(from, `_${pushname} telah meretas grup ini_`)             
                await sleep(1000)
                ikyy.sendMessage(from, 'Succes HIJACKED', text, {quoted: mek})
					break
       case 'cekwatak':
              var namao = pushname
...
//------------------< Menunya Bang:v >-------------------
      case 'infoig':
             ...
             break
      case 'ikyygroup':
             reply('https://chat.whatsapp.com/KQifARljInF8gn9FSNEdY0')
             break
...
//==========================
	if (!isGroup && !isCmd && !kuis) {
                      await ikyy.updatePresence(from, Presence.composing)
                      simi = await fetchJson(`https://leyscoders-api.herokuapp.com/api/simi?kata=${budy}&apikey=IkyOgiwara`)
                      reply(simi.simi)
                    }
 //========================
